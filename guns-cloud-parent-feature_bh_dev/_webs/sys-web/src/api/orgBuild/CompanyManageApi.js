...
export default class CompanyManageApi {
  ...
  // 获取公司列表
  queryList(data) {
    let url = '/guns-cloud-system/entTaskAudit/queryRecord';
    return this.http.get(url, data);
  }
  queryAbnormalList(data) {
    let url = '/guns-cloud-system/entAbnormal/queryListPage';
    return this.http.get(url, data);
  }
  AbnormalAdd(data) {
    let url = '/guns-cloud-system/entAbnormal/AbnormalAdd';
    return this.http.post(url, data);
  }
  queryTaskAuditList(data) {
    let url = '/guns-cloud-system/entTaskAudit/queryListPage';
    return this.http.get(url, data);
  }
  // 审核状态
  changeAuditStatus(data) {
    let url = '/guns-cloud-system/entTaskAudit/changeAuditStatus';
    return this.http.get(url, data);
  }
  AbnormalUpload(data) {
    let url = '/guns-cloud-system/entAbnormal/AbnormalUpload';
    return this.http.upload(url, data);
  }
}
